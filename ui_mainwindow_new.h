...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        LCD_TEMP_C_1->setStyleSheet(QString::fromUtf8(""));
        LCD_TEMP_C_1->setFrameShape(QFrame::NoFrame);
        LCD_TEMP_C_1->setFrameShadow(QFrame::Plain);
        LCD_TEMP_C_1->setDigitCount(8);
        LCD_TEMP_C_1->setSegmentStyle(QLCDNumber::Flat);
        ...
        LCD_TEMP_C_2->setStyleSheet(QString::fromUtf8(""));
        LCD_TEMP_C_2->setFrameShape(QFrame::NoFrame);
        LCD_TEMP_C_2->setFrameShadow(QFrame::Plain);
        LCD_TEMP_C_2->setDigitCount(8);
        LCD_TEMP_C_2->setSegmentStyle(QLCDNumber::Flat);
        ...
        TEMP_C_1->setStyleSheet(QString::fromUtf8(""));
        TEMP_C_1->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        TEMP_C_1->setFrameShape(QFrame::NoFrame);
        ...
        TEMP_C_2->setStyleSheet(QString::fromUtf8(""));
        TEMP_C_2->setLocale(QLocale(QLocale::English, QLocale::UnitedStates));
        TEMP_C_2->setFrameShape(QFrame::NoFrame);
        ...
        line_2->setStyleSheet(QString::fromUtf8("QLine {background-color: #FF9100;}"));
